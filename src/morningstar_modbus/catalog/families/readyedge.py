...
READYEDGE = DeviceProfileSpec(
    ...
    registers=(
        ...
        RegisterSpec("serial_number", 0x0001, words=4, decoder="ascii_hi_lo", category="metadata"),
        ...
        RegisterSpec(
            "system_faults", 0x01E2, words=4, decoder="bitfield_words", category="fault", bits=SYSTEM_FAULTS
        ),
        RegisterSpec("alarms", 0x01EA, words=4, decoder="bitfield_words", category="alarm", bits=ALARMS),
